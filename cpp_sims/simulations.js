...
var ASM_CONSTS = {
  115944: () => { if (document.fullscreenElement) return 1; },  
 115990: () => { return document.getElementById('canvas').width; },  
 116042: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116110: () => { document.exitFullscreen(); },  
 116137: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 116210: () => { if (document.fullscreenElement) return 1; },  
 116256: () => { return document.getElementById('canvas').width; },  
 116308: () => { return screen.width; },  
 116333: () => { document.exitFullscreen(); },  
 116360: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 116493: () => { return window.innerWidth; },  
 116519: () => { return window.innerHeight; },  
 116546: () => { if (document.fullscreenElement) return 1; },  
 116592: () => { return document.getElementById('canvas').width; },  
 116644: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116712: () => { if (document.fullscreenElement) return 1; },  
 116758: () => { return document.getElementById('canvas').width; },  
 116810: () => { return screen.width; },  
 116835: () => { return window.innerWidth; },  
 116861: () => { return window.innerHeight; },  
 116888: () => { if (document.fullscreenElement) return 1; },  
 116934: () => { return document.getElementById('canvas').width; },  
 116986: () => { return screen.width; },  
 117011: () => { document.exitFullscreen(); },  
 117038: () => { if (document.fullscreenElement) return 1; },  
 117084: () => { return document.getElementById('canvas').width; },  
 117136: () => { return parseInt(document.getElementById('canvas').style.width); },  
 117204: () => { document.exitFullscreen(); },  
 117231: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 117289: () => { return screen.width; },  
 117314: () => { return screen.height; },  
 117340: () => { return window.screenX; },  
 117367: () => { return window.screenY; },  
 117394: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 117447: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 117518: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 117575: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 117831: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 117902: () => { if (document.fullscreenElement) return 1; },  
 117948: () => { return window.innerWidth; },  
 117974: () => { return window.innerHeight; },  
 118001: () => { if (document.pointerLockElement) return 1; }
};
