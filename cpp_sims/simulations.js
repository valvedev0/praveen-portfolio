...
var ASM_CONSTS = {
  115796: () => { if (document.fullscreenElement) return 1; },  
 115842: () => { return document.getElementById('canvas').width; },  
 115894: () => { return parseInt(document.getElementById('canvas').style.width); },  
 115962: () => { document.exitFullscreen(); },  
 115989: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 116062: () => { if (document.fullscreenElement) return 1; },  
 116108: () => { return document.getElementById('canvas').width; },  
 116160: () => { return screen.width; },  
 116185: () => { document.exitFullscreen(); },  
 116212: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 116345: () => { return window.innerWidth; },  
 116371: () => { return window.innerHeight; },  
 116398: () => { if (document.fullscreenElement) return 1; },  
 116444: () => { return document.getElementById('canvas').width; },  
 116496: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116564: () => { if (document.fullscreenElement) return 1; },  
 116610: () => { return document.getElementById('canvas').width; },  
 116662: () => { return screen.width; },  
 116687: () => { return window.innerWidth; },  
 116713: () => { return window.innerHeight; },  
 116740: () => { if (document.fullscreenElement) return 1; },  
 116786: () => { return document.getElementById('canvas').width; },  
 116838: () => { return screen.width; },  
 116863: () => { document.exitFullscreen(); },  
 116890: () => { if (document.fullscreenElement) return 1; },  
 116936: () => { return document.getElementById('canvas').width; },  
 116988: () => { return parseInt(document.getElementById('canvas').style.width); },  
 117056: () => { document.exitFullscreen(); },  
 117083: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 117141: () => { return screen.width; },  
 117166: () => { return screen.height; },  
 117192: () => { return window.screenX; },  
 117219: () => { return window.screenY; },  
 117246: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 117299: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 117370: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 117427: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 117683: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 117754: () => { if (document.fullscreenElement) return 1; },  
 117800: () => { return window.innerWidth; },  
 117826: () => { return window.innerHeight; },  
 117853: () => { if (document.pointerLockElement) return 1; },  
