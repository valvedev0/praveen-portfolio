...
var ASM_CONSTS = {
  116296: () => { if (document.fullscreenElement) return 1; },  
 116342: () => { return document.getElementById('canvas').width; },  
 116394: () => { return parseInt(document.getElementById('canvas').style.width); },  
 116462: () => { document.exitFullscreen(); },  
 116489: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 116562: () => { if (document.fullscreenElement) return 1; },  
 116608: () => { return document.getElementById('canvas').width; },  
 116660: () => { return screen.width; },  
 116685: () => { document.exitFullscreen(); },  
 116712: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 116845: () => { return window.innerWidth; },  
 116871: () => { return window.innerHeight; },  
 116898: () => { if (document.fullscreenElement) return 1; },  
 116944: () => { return document.getElementById('canvas').width; },  
 116996: () => { return parseInt(document.getElementById('canvas').style.width); },  
 117064: () => { if (document.fullscreenElement) return 1; },  
 117110: () => { return document.getElementById('canvas').width; },  
 117162: () => { return screen.width; },  
 117187: () => { return window.innerWidth; },  
 117213: () => { return window.innerHeight; },  
 117240: () => { if (document.fullscreenElement) return 1; },  
 117286: () => { return document.getElementById('canvas').width; },  
 117338: () => { return screen.width; },  
 117363: () => { document.exitFullscreen(); },  
 117390: () => { if (document.fullscreenElement) return 1; },  
 117436: () => { return document.getElementById('canvas').width; },  
 117488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 117556: () => { document.exitFullscreen(); },  
 117583: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 117641: () => { return screen.width; },  
 117666: () => { return screen.height; },  
 117692: () => { return window.screenX; },  
 117719: () => { return window.screenY; },  
 117746: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 117799: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 117870: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 117927: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 118183: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 118254: () => { if (document.fullscreenElement) return 1; },  
 118300: () => { return window.innerWidth; },  
 118326: () => { return window.innerHeight; },  
 118353: () => { if (document.pointerLockElement) return 1; }
};
